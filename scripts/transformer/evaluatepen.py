...
from transformer.pena import counting
...
def evaluate(
    ...
    print("eval bpe:", bpe_tgt)
    print("eval tgt_vocab:", target_vocabulary_path)
    path_ali = None
    ...
    reps_sentences, reps_tokens = counting(None, pred_txt, path_ali, max=0)
